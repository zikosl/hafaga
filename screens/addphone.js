            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ justifyContent: "center", flex: 1 }}>
                    <View style={styles.flex}>
                        <TextInput keyboardType="phone-pad" onChangeText={(g) => setPhone(g)} onFocus={() => setFocus(true)} onBlur={() => setFocus(false)} style={[styles.phone, focus && { borderColor: palette.primary }]} />
                        {
                            recived ? (
